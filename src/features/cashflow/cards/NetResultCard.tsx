...
export function NetResultCard({
  ...
  const valueClassName =
    cashBalance >= 0 ? "text-success dark:text-success" : "text-error dark:text-error";
  ...
  return (
    <Card
      className="space-y-4 rounded-2xl border border-border/80 bg-gradient-to-br from-card via-card to-secondary/70 shadow-[0_10px_30px_hsl(var(--overlay) / 0.09)] dark:border-border dark:from-card dark:via-card dark:to-secondary/70"
      aria-busy={isLoading}
