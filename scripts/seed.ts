...
export async function seedTestData(): Promise<SeedResult> {
  ...
  const drafts: SeedTransactionDraft[] = [
    ...
    { date: "2026-01-20", description: "Transferencia enviada", amount: -1000, type: "expense", accountId: "checking", categoryKey: "transferencias" },
    { date: "2026-02-19", description: "Transferencia recebida", amount: 900, type: "income", accountId: "checking" }
  ];
